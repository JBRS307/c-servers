...
def serve_connection(sockobj: socket, client_address):
...
if __name__ == "__main__":
    ...
    argparser.add_argument("--port", type=int, default=3000, help="Server port")
    ...
    sockobj.bind((str(socket.INADDR_ANY), args.port))
    sockobj.listen(15)
